...
const translations = {
    ar: {
        ...
        hero_title: "الترجمة كما يجب أن تكون: <br><span class='gradient-text'>رفيقك الموثوق في عصر الذكاء الاصطناعي</span>",
        hero_subtitle: "لا تضيع وقتك في ترجمة نفس الجملة مرتين. Companion Studio يمنحك بيئة عمل فائقة السرعة تدمج الجهد البشري الإبداعي بجودة الذكاء الاصطناعي الفائقة مع خصوصية محلية آمنة 100% دون اشتراكات شهرية.",
        ...
        bento_section_title: "لماذا Companion Studio هو رفيق المترجم وسلاحه السري؟",
        bento_section_desc: "مُصمم بالكامل لدمج الجهد البشري الإبداعي بجودة الذكاء الاصطناعي، لتلبية احتياجات المترجمين الباحثين عن السرعة والخصوصية المطلقة.",
        ...
        rtl_li3: "الذكاء الاصطناعي كخيار ثنائي: الأولوية القصوى دائماً تكون لذاكرة الترجمة (TM) وقاموس المصطلحات (Termbase)، بينما تُستدعى محركات الذكاء الاصطناعي اختيارياً لتقليل التكلفة وزيادة الجودة.",
    ...
    en: {
        ...
        hero_title: "Translation as it should be: <br><span class='gradient-text'>Your Trusted Companion in the AI Era</span>",
        hero_subtitle: "Never translate the same segment twice. Companion Studio delivers an ultra-fast local environment that merges human creative effort with AI-driven quality, keeping your data 100% private and offline with no monthly fees.",
        ...
        bento_section_title: "Why Companion Studio is a Translator's Ultimate Companion?",
        bento_section_desc: "Engineered from the ground up to merge human creativity with AI intelligence, serving high-velocity translators who demand absolute speed and privacy.",
